            ...
            if v[0]=='i' or v[0]=='I':
                ...
                if v[0]=='b' or v[0]=='B':
                    ...
                    if v[0]!='b' and v[0]!='n' and v[0]!='B' and v[0]!='N': 
                        # Ignore, don't touch this attributes
                        continue
                    # It's Nominal
    ...
    def draft_data_map(self, df, display_map=True):
        ...
        for feature in feature_names:
            ...
            if type(df[feature].iloc[0]) != str:
                min_ = df[feature].min()
                max_ = df[feature].max()
            if len(n) > 3 and type(df[feature].iloc[0]) !=str:
    ...
    def display_topics(lda, terms, n_terms=15, \
        ...
        for topic_idx, topic in enumerate(lda):
            ...
            if word_cloud:
                ...
                TextAnalytics.word_cloud_dic(topic_cloud)
        return
...
class News:
    ...
    def request_pages(df_urls):
        ...
        for i in range(len(df_urls)):
            ...
            stop_sec=5 # Max wait time per attempt
            while n<3:
                try:
